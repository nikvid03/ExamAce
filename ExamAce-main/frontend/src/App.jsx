...
import { BookOpen, Target, Users, Trophy, Clock, ChevronRight, Play, Star, CheckCircle, ArrowRight, Menu, X, Brain, Zap, BarChart3, Video, MessageCircle, Calendar, Award, TrendingUp, Eye, Lightbulb, Smartphone, Headphones, Globe, Shield, Cpu, Gamepad2, LogIn } from 'lucide-react';
...
import SmartStudyPlanner from './components/SmartStudyPlanner.jsx';
import WeaknessDetector from './components/WeaknessDetector.jsx';
import PerformancePredictor from './components/PerformancePredictor.jsx';
import ConceptVisualizer from './components/ConceptVisualizer.jsx';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-2xl font-extrabold text-white">ExamAce</span>
                <div className="mt-1">
                  <span className="inline-block bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-1 rounded-full text-xs font-bold shadow">
                    AI POWERED
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-8 ml-8">
              <a href="#features" className="text-gray-200 hover:text-white font-semibold transition-colors">AI Features</a>
              <a href="#courses" className="text-gray-200 hover:text-white font-semibold transition-colors">Courses</a>
              <a href="#analytics" className="text-gray-200 hover:text-white font-semibold transition-colors">Analytics</a>
              <a href="#testimonials" className="text-gray-200 hover:text-white font-semibold transition-colors">Success Stories</a>
            </div>
            <div className="flex items-center space-x-3 ml-8">
              <button
                className="bg-gradient-to-r from-green-600 to-teal-600 text-white px-5 py-2.5 rounded-xl hover:from-green-700 hover:to-teal-700 transition-all transform hover:scale-105 flex items-center space-x-2 shadow-lg hover:shadow-xl"
              ...
              <button
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-5 py-2.5 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl font-medium"
                onClick={() => navigate('/free-trial')}
              >
                Start Free Trial
              </button>
              <button
                className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-5 py-2.5 rounded-xl hover:from-orange-700 hover:to-red-700 transition-all transform hover:scale-105 flex items-center space-x-2 shadow-lg hover:shadow-xl"
              ...
              <button
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-5 py-2.5 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105 flex items-center space-x-2 shadow-lg hover:shadow-xl"
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-xl border-t border-white/10 shadow-2xl">
              <div className="px-6 py-8 space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <a href="#features" className="block text-gray-300 hover:text-white transition-colors font-medium py-2 px-4 rounded-lg hover:bg-white/10">AI Features</a>
                  <a href="#courses" className="block text-gray-300 hover:text-white transition-colors font-medium py-2 px-4 rounded-lg hover:bg-white/10">Courses</a>
                  <a href="#analytics" className="block text-gray-300 hover:text-white transition-colors font-medium py-2 px-4 rounded-lg hover:bg-white/10">Analytics</a>
                  <a href="#testimonials" className="block text-gray-300 hover:text-white transition-colors font-medium py-2 px-4 rounded-lg hover:bg-white/10">Success Stories</a>
                </div>
                <div className="space-y-3">
                  <button
                    className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white px-6 py-3 rounded-xl hover:from-green-700 hover:to-teal-700 transition-all flex items-center justify-center space-x-2 shadow-lg"
                    onClick={() => navigate('/mentorship')}
                  >
                    <Users className="w-4 h-4" />
                    <span className="font-medium">Mentorship</span>
                  ...
                  <button
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg font-medium"
                    onClick={() => setShowFreeTrial(true)}
                  >
                    Start Free Trial
                  </button>
                  <button
                    className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-3 rounded-xl hover:from-orange-700 hover:to-red-700 transition-all flex items-center justify-center space-x-2 shadow-lg"
                    onClick={() => navigate('/discussion')}
                  >
                    <MessageCircle className="w-4 h-4" />
                    <span className="font-medium">Discussion</span>
                  ...
                  <button
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all flex items-center justify-center space-x-2 shadow-lg"
                    onClick={() => navigate('/login')}
                  >
                    <LogIn className="w-4 h-4" />
                    <span className="font-medium">Login</span>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              {aiFeatures.map((feature, index) => {
                let route = '';
                if (feature.title === 'Smart Study Planner') route = '/smart-study-planner';
                else if (feature.title === 'Weakness Detector') route = '/weakness-detector';
                else if (feature.title === 'Performance Predictor') route = '/performance-predictor';
                else if (feature.title === 'Concept Visualizer') route = '/concept-visualizer';
                return (
                  <div
                    key={index}
                    ...
                    style={{ pointerEvents: route ? 'auto' : 'none' }}
                  >
